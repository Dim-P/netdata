...
#define MSGS_TO_PRODUCE 100000U /**< Messages to be produced per log source **/
...
#define DELAY_BETWEEN_MSG_WRITE 10U /**< Sleep delay (in us) in between consequent messages writes to a file **/
